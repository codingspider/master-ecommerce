                    ...
                    <div class="products">
                      ...
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="{{ URL::to('/products/details/'. $item->id) }}"><img  src="{{ URL::asset($item->images) }}" alt=""></a> </div>
                          <!-- /.image -->
                      ...
                      <div class="row product-micro-row">
                        ...
                        <div class="col2 col-xs-7">
                          <div class="product-info">
                            <h3 class="name"><a href="{{ URL::asset($item->images) }}">{{$item->name }}</a></h3>
                            <div class="rating rateit-small"></div>
