...
<div class="body-content outer-top-xs">
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            ...
            <a data-lightbox="image-1" data-title="Gallery" href="{{ $value->images }}">
											<span class="price-strike">৳{{ $value->price }}</span>
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="{{ URL::asset($value->images) }}" />
                </a>
            ...
            <div id="owl-single-product-thumbnails">
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="{{ URL::asset($value->images) }}" />
                    </a>
                </div>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="{{ URL::to('/wishlist/view/'.$value->id)}}">
