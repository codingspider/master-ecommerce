<?php namespace App\Http\Controllers;
	...
	class AdminLogosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'checkbox','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
