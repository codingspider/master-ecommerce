<?php namespace App\Http\Controllers;
	...
	class AdminHotDealsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Manufacture Id","name"=>"manufacture_id","join"=>"categories,id"];
			...
			//$this->form[] = ["label"=>"Manufacture Id","name"=>"manufacture_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"manufacture,id"];
